...
import 'package:flutter_riverpod_todo_app/screens/homepage.dart';
import 'package:flutter_riverpod_todo_app/screens/sign_in_form.dart';
import 'package:flutter_riverpod_todo_app/screens/vertical_slider_caraousel.dart';
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              title: const Text('Fullscreen slider demo',style: TextStyle(fontSize: 16,color: Colors.black),),
              onTap: () {
                Navigator.push(
                  context,
            ...
            ListTile(
              title: Text('VerticalSliderDemo',style: TextStyle(fontSize: 16,color: Colors.black)),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  VerticalSliderDemo()),
                );
                // Update the state of the app.
                // ...
              },
